    ...
    <View style={{height: '100%', backgroundColor: 'white'}}>
      ...
      <View style={[styleIn.mainContainer, styles.shadow]}>
        <View style={[styles.ShadowLight, styleIn.InputBox]}>
          <Image
            source={{uri: 'http://cdn.onlinewebfonts.com/svg/img_386071.png'}}
        ...
        <View style={[styles.ShadowLight, styleIn.InputBox]}>
          <Image
            source={{uri: 'http://cdn.onlinewebfonts.com/svg/img_228829.png'}}
            style={{width: 20, height: 24}}></Image>
        ...
        <TouchableOpacity
          style={[styles.buttonBox, {backgroundColor: 'cornflowerblue'}]}>
