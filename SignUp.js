...
export default function SignUp() {
  return (
    <View style={{ height: '100%', backgroundColor: 'white' }}>
      ...
      <Text style={styleIn.mainHeading} >SIGN UP</Text>

      <View style={[styleIn.mainContainer, styles.shadow]}>

        <View style={[styles.ShadowLight, styleIn.InputBox]}>

          <Image source={{ uri: 'https://tse3.mm.bing.net/th?id=OIP.w2McZSq-EYWxh02iSvC3xwHaHa&pid=Api&P=0' }} style={{ width: 25, height: 25 }}></Image>

          <TextInput placeholder='Username' style={styleIn.inputField}></TextInput>
        </View>
